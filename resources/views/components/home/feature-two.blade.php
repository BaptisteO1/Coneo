<div class="flex flex-col h-full items-center md:pt-20 gap-x-7 mx-6 md:mx-12 my-10 md:my-12 lg:my-16">
    <h1 class="text-rose-600 font-extrabold text-center text-3xl md:text-5xl">Envolez-vous vers la connaissance !</h1>
