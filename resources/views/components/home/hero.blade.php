<div class="bg-cover bg-center h-full md:min-h-screen" style="background-image: url('/images/hero-accueil.png');">
    <div class="w-full text-black md:w-1/2 flex flex-col gap-6 items-center text-center md:text-start md:items-start md:mx-24 my-10 md:my-12 lg:my-16">
